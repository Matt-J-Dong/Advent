...
direction_visits = [[guard_location.copy(),guard_direction.copy()]]
while guard == True:
    ...
    if(guard_location in blocks):
        ...
        #print(num)
    #print(guard_location)
    if(guard_location not in direction_visits):
        direction_visits.append([guard_location.copy(),guard_direction.copy()])
        #print("yoy")
